...
class DemoRenderer extends GLSurfaceView_SDL.Renderer {
    ...
    Point getScaledDimensions(int containerWidth, int containerHeight) {
        ...
        int gameWidth = mCustomWidth == 0 ? nativeGetWidth() : mCustomWidth;
        int gameHeight = mCustomHeight == 0 ? nativeGetHeight() : mCustomHeight;
    ...
    private int mCustomWidth, mCustomHeight;
